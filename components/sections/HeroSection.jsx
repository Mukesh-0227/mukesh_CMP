...
import { getSnapScrollTop } from '@/lib/viewport'
...
export default function HeroSection() {
  ...
  function handleViewProjects() {
    ...
    if (scroller) {
      gsap.to(scroller, { scrollTop: getSnapScrollTop(3), duration: 1.0, ease: 'power3.inOut' })
    }
  }
